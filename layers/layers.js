...
var format_SomnathAmenities_17 = new ol.format.GeoJSON();
var features_SomnathAmenities_17 = format_SomnathAmenities_17.readFeatures(json_SomnathAmenities_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SomnathAmenities_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SomnathAmenities_17.addFeatures(features_SomnathAmenities_17);
var lyr_SomnathAmenities_17 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SomnathAmenities_17, 
                style: style_SomnathAmenities_17,
                popuplayertitle: 'Somnath Amenities',
                interactive: true,
                title: '<img src="styles/legend/SomnathAmenities_17.png" /> Somnath Amenities'
            });
var format_MajorPlaces_18 = new ol.format.GeoJSON();
var features_MajorPlaces_18 = format_MajorPlaces_18.readFeatures(json_MajorPlaces_18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MajorPlaces_18 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MajorPlaces_18.addFeatures(features_MajorPlaces_18);
var lyr_MajorPlaces_18 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MajorPlaces_18, 
                style: style_MajorPlaces_18,
                popuplayertitle: 'Major Places',
                interactive: true,
                title: '<img src="styles/legend/MajorPlaces_18.png" /> Major Places'
            });
...
lyr_OSMStandard_0.setVisible(true);lyr_GoogleHybrid_1.setVisible(true);lyr_GoogleSatellite_2.setVisible(true);lyr_FalseColourComposite_3.setVisible(true);lyr_Elevation_4.setVisible(true);lyr_LanduseClasses_5.setVisible(true);lyr_InfrastructureLanduse_6.setVisible(true);lyr_VillagesBoundary_7.setVisible(true);lyr_Waterbody_8.setVisible(true);lyr_RiversandStreams_9.setVisible(true);lyr_Canals_10.setVisible(true);lyr_Roads500M_11.setVisible(true);lyr_Railway_12.setVisible(true);lyr_Roads_13.setVisible(true);lyr_10KmBuffer_14.setVisible(true);lyr_4KmBuffer_15.setVisible(true);lyr_500MBuffer_16.setVisible(true);lyr_SomnathAmenities_17.setVisible(true);lyr_MajorPlaces_18.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_GoogleHybrid_1,lyr_GoogleSatellite_2,lyr_FalseColourComposite_3,lyr_Elevation_4,lyr_LanduseClasses_5,lyr_InfrastructureLanduse_6,group_Admin,lyr_10KmBuffer_14,lyr_4KmBuffer_15,lyr_500MBuffer_16,lyr_SomnathAmenities_17,lyr_MajorPlaces_18];
...
lyr_SomnathAmenities_17.set('fieldAliases', {'Name': 'Name', 'descriptio': 'descriptio', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMo': 'altitudeMo', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', 'Layer': 'Layer', 'PaperSpace': 'PaperSpace', 'SubClasses': 'SubClasses', 'Linetype': 'Linetype', 'EntityHand': 'EntityHand', 'Text': 'Text', });
lyr_MajorPlaces_18.set('fieldAliases', {'id': 'id', 'Name': 'Name', });
...
lyr_SomnathAmenities_17.set('fieldImages', {'Name': 'TextEdit', 'descriptio': 'TextEdit', 'timestamp': 'TextEdit', 'begin': 'TextEdit', 'end': 'TextEdit', 'altitudeMo': 'TextEdit', 'tessellate': 'TextEdit', 'extrude': 'TextEdit', 'visibility': 'TextEdit', 'drawOrder': 'TextEdit', 'icon': 'TextEdit', 'Layer': 'TextEdit', 'PaperSpace': 'TextEdit', 'SubClasses': 'TextEdit', 'Linetype': 'TextEdit', 'EntityHand': 'TextEdit', 'Text': 'TextEdit', });
lyr_MajorPlaces_18.set('fieldImages', {'id': 'TextEdit', 'Name': 'TextEdit', });
...
lyr_Roads500M_11.set('fieldLabels', {'osm_id': 'hidden field', 'code': 'hidden field', 'fclass': 'inline label - always visible', 'name': 'hidden field', 'ref': 'hidden field', 'oneway': 'hidden field', 'maxspeed': 'hidden field', 'layer': 'hidden field', 'bridge': 'hidden field', 'tunnel': 'hidden field', });
...
lyr_SomnathAmenities_17.set('fieldLabels', {'Name': 'inline label - always visible', 'descriptio': 'hidden field', 'timestamp': 'hidden field', 'begin': 'hidden field', 'end': 'hidden field', 'altitudeMo': 'hidden field', 'tessellate': 'hidden field', 'extrude': 'hidden field', 'visibility': 'hidden field', 'drawOrder': 'hidden field', 'icon': 'hidden field', 'Layer': 'hidden field', 'PaperSpace': 'hidden field', 'SubClasses': 'hidden field', 'Linetype': 'hidden field', 'EntityHand': 'hidden field', 'Text': 'hidden field', });
lyr_MajorPlaces_18.set('fieldLabels', {'id': 'hidden field', 'Name': 'inline label - always visible', });
lyr_MajorPlaces_18.on('precompose', function(evt) {
